	...
	SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http,
		...
		return http.csrf(ServerHttpSecurity.CsrfSpec::disable).cors(Customizer.withDefaults())
				.authorizeExchange(exchanges -> exchanges.pathMatchers(HttpMethod.OPTIONS, "/**").permitAll()
						...
						.pathMatchers(HttpMethod.POST, "/api/v1/orders").hasRole("BUYER")
						.pathMatchers(HttpMethod.GET, "/api/v1/organizer/events/*/seat-map").hasRole("ORGANIZER")
						.pathMatchers(HttpMethod.PUT, "/api/v1/organizer/events/*/seat-map").hasRole("ORGANIZER")
						.pathMatchers(HttpMethod.POST, "/api/v1/events/*/check-ins").hasRole("ORGANIZER")
						.pathMatchers("/internal/v1/**").denyAll().pathMatchers("/actuator/**").denyAll()
