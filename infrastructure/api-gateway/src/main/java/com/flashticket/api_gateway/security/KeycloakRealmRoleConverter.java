...
/**
 * Converts Keycloak business roles from {@code realm_access.roles} to Spring Security authorities.
 * Keycloak default roles and malformed claim values are deliberately ignored.
 */
