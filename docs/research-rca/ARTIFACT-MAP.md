...
| D-PROTOCOL | Method/experiment specification · CANONICAL_DECISION | TD-v1.1 REVIEW_READY; design CANDIDATE, human approval/E authorization OPEN; C1 preserved | P: `R/task-d-method-and-experiment-specification.md` | D → E–I/J | Repo; **L1 cho E**, authoritative technical choices |
| ADVISOR-U23 | Verbatim old-phase guidance + current Minh clarification · DETAILED_EVIDENCE | Relative provenance confirmed RCA018–021; exact original date/channel NOT VERIFIED; no reduction of DT18 | P: `docs/evidence/advisor-direction/2026-09-23-huong-dan-do-minh-cung-cap.md` | D → H/J; source owner Minh | Repo; L2 source; separate from22/08 letter |
...
| D11-RECONCILE | Conflict/modality/GT/component matrices + adjudication/inventory · DETAILED_EVIDENCE | `task-d/td-v1.1-reconciliation-evidence.md` | D → Minh/E/J | Current revision evidence; protocol remains in P; old D-EVIDENCE preserved |
