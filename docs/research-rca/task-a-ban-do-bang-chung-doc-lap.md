...
> **Nguồn bổ sung TD-v1.1, 23/09/2026:** [hướng dẫn do Minh cung cấp](../evidence/advisor-direction/2026-09-23-huong-dan-do-minh-cung-cap.md) thực sự chứa PageRank/subgraph/GNN, P/R/F1/MRR/NDCG và LLM. Đây là nguồn khác thư 22/08; không hủy đính chính ở trên. Minh xác nhận nó thuộc giai đoạn đề tài trước, còn giá trị cho phần phương pháp RCA nhưng không giảm nhiệm vụ xây dựng FlashTicket ([RCA-018–021](RESEARCH-DECISIONS.md)). Ngày/kênh gửi gốc vẫn NOT VERIFIED. Bảng lịch sử dưới không được đổi thành bằng chứng “đã biết từ đầu”; coverage hiện hành ở TD-v1.1 §15.
